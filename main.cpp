...
// Project 2
//
// This file parses the data file and adds the links to
// a hash map.  You are responsible for implementing the 
// add_link_to_map method.
//
#include <iostream>
#include <fstream>
#include <vector>
...
// After this method finishes, "to" should be in the vector "from"
// is mapped to.
...
int main() 
{
    std::cout<<"Which file do you want to look at? (\"friends\" or \"wikipedia\")"<<std::endl;
    std::string name;
    std::cin>>name;
